 ...
 * brief The Embedded Wireless Framework Sierra common adapter driver
 ****************************************************************************/
...
ewf_adapter_api_info ewf_adapter_sierra_common_api_info =
{
    ewf_adapter_sierra_common_info,
    ewf_adapter_sierra_common_get_ipv4_address,
    ewf_adapter_sierra_common_get_ipv4_netmask,
    ewf_adapter_sierra_common_get_ipv4_gateway,
    ewf_adapter_sierra_common_get_ipv4_dns,
    NULL,
    NULL,
    NULL,
};
